"""Alembic environment for the EDIS intelligence service (L3).
...
migrations are hand-authored raw DDL (the findings / forecasts / evidence tables
are owned here, not reflected from ORM models — the X3 store ORM models must
MATCH this schema).
"""
